...
fixtures/decoder-policy/
  ...
  multicall-call-array.test.mjs  # DEC-06b 49개 정의, 사용자 실행 대기
...
| DEC-06b Call[] | 구현·정적 검토 완료, 사용자 실행 대기. 49개·통합 563개 정의이며 통과 수 아님 |
| DEC-06c·DEC-07·소스 이관 | 미착수. 06c는 06b 사용자 검증 후 진행 |
