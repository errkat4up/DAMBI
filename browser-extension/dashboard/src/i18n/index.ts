 ...
 *
 * Init is a function, NOT a module-level side effect: main.tsx calls it at a
 * controlled point before the first render, and static imports would hoist an
 * auto-init above that call.
 */
...
/** Superseded locale keys; used once as a seed, never written. */
const LEGACY_LOCALE_KEYS = ["dambi:market-locale"] as const;
