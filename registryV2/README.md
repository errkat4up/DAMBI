...
condition `assertion.repository == 'errkat4up/DAMBI'` and a `principalSet` binding for
`attribute.repository/errkat4up/DAMBI` mean **only** GitHub Actions runs from that repo can
